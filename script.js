...
const quiz = [
    ...
    { type: "fill",   question: "Fill in the blank: CSS stands for ______ Style Sheets.", options: ["Cascading"], correct: ["Cascading"] },
    ...
    { type: "fill",   question: "In computing, CPU stands for ______ Processing Unit.", options: ["Central"], correct: ["Central"] },
